...
const Landing = () => {
  ...
  const metrics = [
    { label: "STRAIN", value: "12.8", status: "Moderate", color: "text-primary" },
    { label: "RECOVERY", value: "73%", status: "Green", color: "text-accent" },
    { label: "SLEEP", value: "7h 42m", status: "Good", color: "text-chart-3" }
  ];
  ...
  const benefits = [
    "91 more minutes of weekly activity",
    "2.3 more hours of sleep per week", 
    "10% higher HRV on average",
    "Better health outcomes across all metrics"
  ];
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-3">
            <Button 
              ...
              className="whoop-button text-foreground hover:bg-secondary"
            >
              Sign In
            </Button>
            <Button 
              onClick={() => navigate('/auth')} 
              className="whoop-button bg-primary text-primary-foreground hover:bg-primary/90"
            >
              Join Now
            </Button>
          </div>
      ...
      <div className="container mx-auto px-6 py-20">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20">
          <h1 className="text-6xl md:text-7xl font-bold tracking-tight mb-6 animate-slide-up">
            ...
            <span className="text-primary"> DIABETIKS</span>
          </h1>
          ...
          <Button 
            size="lg" 
            className="whoop-button bg-primary text-primary-foreground px-8 py-4 text-lg font-semibold animate-slide-up" 
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-20">
          {metrics.map((metric, index) => (
            <Card 
              key={index} 
              className="whoop-card p-8 text-center animate-scale-in hover:scale-105 transition-transform cursor-pointer"
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          {features.map((feature, index) => (
            <Card 
              key={index} 
              className="whoop-card p-6 hover:scale-105 transition-all duration-200 animate-slide-up"
              style={{ animationDelay: `${index * 0.1}s` }}
            >
        ...
        <div className="text-center">
          <div className="whoop-card p-12 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                size="lg" 
                className="whoop-button bg-primary text-primary-foreground px-8 py-4 text-lg font-semibold group" 
                onClick={() => navigate('/auth')}
              >
                Join Now
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="whoop-button border border-border text-foreground hover:bg-secondary px-8 py-4 text-lg"
                onClick={() => navigate('/auth')}
              >
